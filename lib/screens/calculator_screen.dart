...
class CalculatorScreen extends StatelessWidget {
  ...
  /*
     Agregar (inyectar) el controller para que lo podamos usar.
     Se agrega a este nivel para tener mas alcance y apartir de aquí es donde ya lo necesito.
     Con esto ya es suficiente, no hay necesidad de pasar el context.
  */
         ...
         // margin: EdgeInsets.symmetric( horizontal: 5 ),
          child: Column(
            children: [
              ...
              /*
              *Estos calculos es lo unico que debemos redibujar, así que se movieron a
              *otro widget
              SubResult( text: '1000' ),
              SubResult( text: 'X' ),
              SubResult( text: '1000' ),
